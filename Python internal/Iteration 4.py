...
def first_menu():
    ...
    order_btn = Button(initial, text="Order food", image=order_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda:[order_screen(), initial.grid_forget()])
    order_btn.grid(row=2, column=1, columnspan=3, pady=10)
    
    view_img = ImageTk.PhotoImage(Image.open("images/view.png").resize((40, 25)))
    view_btn = Button(initial, text="View order", image=view_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [initial.grid_forget(), view_order()])
    ...
    checkout_btn = Button(initial, text="Checkout order", image=checkout_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [initial.grid_forget(), checkout()])
    ...
    login_btn = Button(initial, text="User Login", image=login_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [initial.grid_forget(), login()])
...
def main_menu():
    ...
    order_img = ImageTk.PhotoImage(Image.open("images/order.png").resize((40, 25)))
    order_btn = Button(main, text="Order food", image=order_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda:[order_screen(), main.grid_forget()])
    order_btn.grid(row=2, column=1, columnspan=3, pady=10)
    
    view_img = ImageTk.PhotoImage(Image.open("images/view.png").resize((40, 25)))
    view_btn = Button(main, text="View order", image=view_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [main.grid_forget(), view_order()])
    view_btn.grid(row=3, column=1, columnspan=3, pady=10)

    checkout_img = ImageTk.PhotoImage(Image.open("images/checkout.png").resize((40, 25)))
    checkout_btn = Button(main, text="Checkout order", image=checkout_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [main.grid_forget(), checkout()])
    checkout_btn.grid(row=4, column=1, columnspan=3, pady=10)

    logout_img = ImageTk.PhotoImage(Image.open("images/logout.png").resize((40, 25)))
    logout_btn = Button(main, text="Log out", image=logout_img, compound="left", bg="#781d4b", fg="white", width=250, font=("Calibri", 15), command=lambda: [messagebox.showinfo("Logged out!", "Logged out successfully!"), reset(), main.grid_forget(), first_menu()])
    logout_btn.grid(row=5, column=1, padx=10, pady=10, columnspan=3)

def order_screen():
    global item_img, hotmenu, logo_img
    ...
    add_btn = Button(hotmenu, text="Add to order", command=lambda: add_item(combo, number, message), bg="#781d4b", fg="white", font=("Calibri", 12))
    ...
    back_btn = Button(hotmenu, text="Back", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: back_menu(frame=hotmenu))
    back_btn.grid(row=5, columnspan=2, pady=10)  
...
def login():
    ...
    title = Label(loginwindow, text="BDSC Cafe click and collect", fg="#781d4b", bg="white", font=("Calibri", 20))
    ...
    username = Label(loginwindow, text="Username", fg="#781d4b", bg="white", font=("Calibri Bold", 15))
    ...
    password = Label(loginwindow, text="Password", fg="#781d4b", bg="white", font=("Calibri Bold", 15))
    ...
    messages = Label(loginwindow, fg="#781d4b", bg="white", font=("Calibri", 15))
    messages.grid(row=4, columnspan=3, pady=10)

    login_btn = Button(loginwindow, text="Login", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: check_login(username_entry, password_entry, messages))
    login_btn.grid(row=5, column=1, columnspan=2, pady=10)

    register_btn = Button(loginwindow, text="Register", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: [loginwindow.grid_forget(), register()])
    register_btn.grid(row=5, column=2, pady=10, padx=20, sticky="e")

    back_btn = Button(loginwindow, text="Back", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: back_menu(frame=loginwindow))
...
def register():
    ...
    username = Label(registerwindow, text="Username", bg="white", fg="#781d4b", font=("Calibri Bold", 15))
    username.grid(row=2, column=1, padx=10, pady=10)
    username_entry = Entry(registerwindow, bg="white", font=("Calibri Bold", 12), highlightthickness=2, highlightbackground="#781d4b")
    username_entry.grid(row=2, column=2, padx=10, pady=10)

    password = Label(registerwindow, text="Password", bg="white", fg="#781d4b", font=("Calibri Bold", 15))
    password.grid(row=3, column=1, padx=10, pady=10)
    password_entry = Entry(registerwindow, bg="white", font=("Calibri", 12), highlightthickness=2, highlightbackground="#781d4b")
    password_entry.grid(row=3, column=2, padx=10, pady=10)

    age = Label(registerwindow, text="Age", bg="white", fg="#781d4b", font=("Calibri Bold", 15))
    age.grid(row=4, column=1, padx=10, pady=10)
    age_entry = Spinbox(registerwindow, bg="white",font=("Calibri", 12), from_=1, to=100, highlightthickness=2, highlightbackground="#781d4b")
    age_entry.grid(row=4, column=2, padx=10, pady=10)

    message = Label(registerwindow, text="", bg="white", fg="#781d4b", font=("Calibri Bold", 15))
    message.grid(row=5, columnspan=3, pady=10)

    register_btn = Button(registerwindow, text="Register", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: register_account(username_entry, password_entry, age_entry, message))
    register_btn.grid(row=6, column=1, columnspan=2, pady=10)

    login_btn = Button(registerwindow, text="Login", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: [registerwindow.grid_forget(), login()])
    login_btn.grid(row=6, column=2, pady=10, padx=20, sticky="e")

    back_btn = Button(registerwindow, text="Back", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: back_menu(frame=registerwindow))
...
def view_order():
    ...
    back = Button(viewwindow, text="Back", command=lambda: [viewwindow.pack_forget(), back_menu(frame=viewwindow)], bg="#781d4b", fg="white", font=("Calibri", 12))
...
def checkout():
    ...
    if order != []:
        ...
        confirm = Button(checkoutwindow, text="Confirm order", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: [checkoutwindow.grid_forget(), finish()])
    ...
    back = Button(checkoutwindow, text="Back", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: [checkoutwindow.grid_forget(), back_menu(frame=checkoutwindow)])
...
#Brings the user to the first frame so they can order again if they wish
    home = Button(completed, text="Home", bg="#781d4b", fg="white", font=("Calibri", 12), command=lambda: [completed.grid_forget(), first_menu()])
